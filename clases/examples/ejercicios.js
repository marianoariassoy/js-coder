/*
LOS EJERCICIOS QUE SE DETALLAN A POSTERIOR NO DEBEN SER REALIZADOS OBLIGATORIAMENTE, ES SOLO COMO PRACTICA Y NO SERÁN EVALUADOS.
*/

const minutosASegundos = (minutos) => {
  /*
